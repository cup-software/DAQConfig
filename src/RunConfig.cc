    ...
    : TObject()
{
  ...
  TCBCONFIGMENU[0] = "CW";
  TCBCONFIGMENU[1] = "PTRIG";
  TCBCONFIGMENU[2] = "DLY";
  TCBCONFIGMENU[3] = "MTHRF";
  TCBCONFIGMENU[4] = "PSCF";
  TCBCONFIGMENU[5] = "DTF";
  TCBCONFIGMENU[6] = "MTHRMU";
  TCBCONFIGMENU[7] = "PSCMU";
  TCBCONFIGMENU[8] = "DTMU";
  TCBCONFIGMENU[9] = "MTHRLS";
  TCBCONFIGMENU[10] = "PSCLS";
  TCBCONFIGMENU[11] = "DTLS";
  TCBCONFIGMENU[12] = "TRGON";
  TCBCONFIGMENU[13] = "EXT";
  TCBCONFIGMENU[14] = "EXTOUTWIDTH";
  TCBCONFIGMENU[15] = "GATEDLY";
  TCBCONFIGMENU[16] = "GATEWIDTH";
  TCBCONFIGMENU[17] = "TYPE";
  TCBCONFIGMENU[18] = "CWAMORE";
...
bool RunConfig::ConfigTCB(std::ifstream & ticket, TCBConf * conf)
{
  ...
  while (true) {
    ...
    switch (fTCBItem[key]) {
      ...
      case EXTOUTWIDTH_TCB: {
        iss >> val[0];
        conf->SetEXTOUTWIDTH(val[0]);
        break;
      }
      case GATEWIDTH_TCB: {
        iss >> val[0];
        conf->SetGATEWIDTH(val[0]);
        break;
      }
      case GATEDLY_TCB: {
        iss >> val[0];
        conf->SetGATEDLY(val[0]);
        break;
      }
      case TYPE_TCB: {
        iss >> val[0];
